...
namespace WebApi.Data
{
    public partial class DB_PauloVictorContext : DbContext
    {
        ...
        //To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=meuservidorsql02.database.windows.net;Initial Catalog=mySampleDataBase;User ID=azureuser;Password=Password01;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"
                    );
            }
        }
